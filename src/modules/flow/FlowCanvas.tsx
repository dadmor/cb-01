/* ============================================
   ...
   // ============= UI kontekst dla opcji prezentacji ============
   export const FlowUIContext = createContext<{ showSceneCovers: boolean }>({
     showSceneCovers: false,
   });
   ...
   // ============= Canvas =============
   export const FlowCanvas: React.FC<{ showSceneCovers?: boolean }> = React.memo(
     ({ showSceneCovers = false }) => {
       ...
       return (
         <ReactFlowProvider>
           <FlowUIContext.Provider value={{ showSceneCovers }}>
             <ReactFlow
               nodes={nodes}
               edges={enrichedEdges}
               nodeTypes={nodeTypes}
