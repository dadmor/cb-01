/* ============================================
   ...
   export const SceneNode: React.FC<SceneNodeProps> = ({ id, data, selected }) => {
     const { label, description, durationSec, conditions, videoId, isPriority, coverImage } = data;
     ...
     return (
       ...
       >
         ...
         <div className="p-4 h-full flex flex-col">
           ...
           {/* ▼ Opcjonalna okładka sceny */}
           {ui.showSceneCovers && coverImage && (
           ...
           <div className="mt-auto">
             <div className="flex items-center justify-between mb-1.5">
               <span className="text-xs text-zinc-500">{videoId ? "Video" : "Duration"}</span>
